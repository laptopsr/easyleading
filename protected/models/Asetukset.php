...
class Asetukset extends CActiveRecord
{
	...
	public function attributeLabels()
	{
		return array(
			...
			'iban' => 'Iban',
			'bic' => 'Bic',
			'netvisor_customer_id' => 'Netvisor Customer',
			'netvisor_partner_id' => 'Netvisor Partner',
			'netvisor_userkey' => 'Netvisor Userkey',
			'netvisor_partnerkey' => 'Netvisor Partnerkey',
			'netvisor_kaytto' => 'Netvisor Kaytto',
			'netvisor_organisation_identifier' => 'Netvisor Organisation Identifier',
			'netvisor_host' => 'Netvisor Host',
