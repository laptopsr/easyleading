                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="page-title">
                            <h1>
                                Laskutus <a href="<?php echo Yii::app()->request->baseUrl.'/index.php/laskut/create'; ?>" data-toggle="tooltip" data-placement="right" title="Luo asiakas"><i class="fa fa-plus-square"></i></a>
                            </h1>
                            <ol class="breadcrumb">
