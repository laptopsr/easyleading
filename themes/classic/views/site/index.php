                            ...
                            <div class="container">
                                <div class="row vcenter-md">
                                    ...
                                    <div class="col-md-6 col-md-pull-5 hidden-sm hidden-xs">
                                        <!--<img class="img-responsive img-full" src="<?php echo Yii::app()->request->baseUrl; ?>/classic_assets/img/misc/frontend_home1.png" alt="" />-->
                        ...
                        <div class="container text-center">
                            <div class="row">
                                <div class="col-md-6 col-md-offset-3">
                                    <h2 class="h1 display-2"><?php echo Yii::app()->name; ?></h2>
